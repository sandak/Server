...
public abstract class ObservableCommonModel extends Observable implements Model {
	...
	protected HashMap<Maze3d, Solution<Position>> solutionMap; // a name -->>
																// solution map.
	protected HashMap<String, Position> charPositionMap; // a name -->>
															// character
															// position map.
	protected ExecutorService threadPool; // thread pool to manage all important
											// threads.
	...
	public void setProperties(Properties properties) {
		...
		// using the system properties get a fixed thread pool.
		threadPool = Executors.newFixedThreadPool(properties.getMaxThreads()); 
		bufferdpool.shutdown(); // letting all threads in the old thread pool to
								// finish.
	}
